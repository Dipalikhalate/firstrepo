...
class Profile(models.Model):
    ...
    pinterest_url = models.CharField(max_length=60, null=True, blank=True)
...
class Post(models.Model):
    ...
    snippet = models.CharField(max_length=60)
    likes = models.ManyToManyField(User, related_name='blog_posts')
    # Unlike = models.ManyToManyField(User, related_name='blog_posts')
